...
<div align="center">
  ...
  <a href="https://www.linkedin.com/in/mnlaugh/" target="_blank">
    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/linkedin/linkedin-original.svg" height="40" alt="LinkedIn" />
  </a>
  <a href="https://www.malt.fr/profile/nicolasmetivier" target="_blank">
    <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn-1.webcatalog.io%2Fcatalog%2Fmalt%2Fmalt-icon-filled-256.png%3Fv%3D1675614046082&f=1&nofb=1&ipt=31f61b6b31c1e96ff96cb61e54a7853d8e89f3d0ec992e43ab3e4976091d0c09" height="40" alt="Malt" />
  </a>
</div>
...
<div align="center">
    <a href="https://git.io/streak-stats"><img src="https://streak-stats.demolab.com?user=MNLaugh&theme=transparent&stroke=4F46E5&fire=EB5454&ring=4F46E5&currStreakNum=EBEBEB&sideNums=EBEBEB&currStreakLabel=4F46E5&sideLabels=4F46E5&dates=4F46E5C1&excludeDaysLabel=4F46E5C1" alt="GitHub Streak" /></a>
</div>
...
Self-taught **Fullstack** developer for **11 years**, specialized in **TypeScript, React, Node.js and Flutter**.
I enjoy building **complete applications** (frontend + backend + mobile) and automating complex tasks.
My expertise in **API reverse engineering** allows me to integrate third-party services even when undocumented.
...
- **Self-taught for 11 years**: learning by doing, constant technology watch.
- **Former TSSR instructor** (Senior Systems and Networks Technician):
  - Simplifying technical concepts.
  - Creating clear documentation.
  - Mentoring learners.
- **Degree**:
  - TAI (IT Support Technician) - High school level equivalent.
...
- **Project management** (from idea to production)
- **Technical curiosity** (technology watch, experimentation)

---

## What I'm looking for

- **Freelance or permanent position, 100% remote** (available immediately).
- **Real-world projects** with user impact (web/mobile, automation, scraping).
- **Modern stack** (TypeScript, React, Node.js, Flutter).
- **Supportive environment** (junior-friendly, mentoring welcome).
- **Documentation culture** (clean and well-documented code).
